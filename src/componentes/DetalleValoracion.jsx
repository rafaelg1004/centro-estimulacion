...
const DetalleValoracion = () => {
  ...
  try {
    const response = await fetch("https://centro-backend-production.up.railway.app/api/exportar-pdf", {
      method: "POST",
      headers: {
  ...
  useEffect(() => {
    fetch(`https://centro-backend-production.up.railway.app/api/valoraciones/${id}`)
      .then((res) => res.json())
