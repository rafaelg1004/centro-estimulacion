    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-100 via-purple-100 to-pink-100 py-10 px-4">
      <div className="max-w-4xl mx-auto">
        <div className="bg-white rounded-3xl shadow-2xl border border-purple-100 overflow-hidden">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
              ...
              <div className="flex gap-2">
                <button
                  ...
                  disabled={guardando}
                  className="bg-white text-purple-700 hover:bg-purple-50 font-bold px-6 py-2 rounded-xl shadow-md transition flex items-center gap-2"
                >
                  {guardando ? (
          ...
          <div className="p-6 bg-gray-50 border-t border-purple-50 flex justify-end">
            <button
               onClick={guardarCambios}
               disabled={guardando}
