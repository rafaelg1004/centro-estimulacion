  ...
  secciones: [
    ...
    },
    {
      ...
      campos: [
        ...
        },
        {
          ...
          tipo: "select",
          opciones: [{ valor: "21", etiqueta: "Enfermedad general" }],
          requerido: true,
          valorPorDefecto: "21",
        },
        {
    ...
    },
    {
      ...
      campos: [
        ...
        {
          nombre: "moduloLactancia.experienciaLactancia",
          etiqueta: "¿Ha tenido experiencia previa en lactancia?",
          tipo: "select",
          opciones: ["Sí", "No"],
          requerido: true,
        },
        {
          nombre: "moduloLactancia.comoFueExperiencia",
          etiqueta: "¿Cómo fue esa experiencia?",
          tipo: "textarea",
        },
        {
          nombre: "moduloLactancia.dificultadesLactancia",
          etiqueta: "Dificultades actuales",
          tipo: "textarea",
        },
        {
          nombre: "moduloLactancia.deseaAmamantar",
          etiqueta: "¿Desea amamantar a su bebé?",
          tipo: "select",
          opciones: ["Sí", "No", "Duda"],
          requerido: true,
        },
    ...
    },
    {
      ...
      campos: [
        {
          nombre: "moduloLactancia.pechosNormales",
          etiqueta: "Pechos de aspecto normal",
          tipo: "checkbox",
        },
        {
          nombre: "moduloLactancia.pechosDolorosos",
          etiqueta: "Pechos dolorosos al tacto",
          tipo: "checkbox",
        },
        {
          nombre: "moduloLactancia.pechosSecrecion",
          etiqueta: "Presencia de secreciones/grietas",
          tipo: "checkbox",
        },
        {
          nombre: "moduloLactancia.formaPezon",
      ...
      campos: [
        {
          ...
          etiqueta: "Diagnóstico / Impresión Clínica",
          tipo: "textarea",
          requerido: true,
        },
        {
          nombre: "planTratamiento",
          etiqueta: "Plan de Intervención / Recomendaciones",
          tipo: "textarea",
          requerido: true,
        },
      ],
